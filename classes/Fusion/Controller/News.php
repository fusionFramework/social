 ...
 */
class Fusion_Controller_News extends Controller_Fusion_Site
{
	...
	public function action_post()
	{
		...
		$post = ORM::factory('Quill_Topic', $this->request->param('id'));
	...
	public function action_comment()
	{
		...
		else
		{
			...
			$reply = ORM::factory('Quill_Topic')
				->where('quill_topic.id', '=', $this->request->param('id'))
				->find()
				->create_reply($values);

			Plug::fire('news.parse', [$reply]);
